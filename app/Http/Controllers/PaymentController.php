...
class PaymentController extends Controller
{
    public function redirectToPayment($id)
    {
        ...
        try {
            ...
            // Mengubah status pendaftaran menjadi 2
            $pendaftaran->status_pembayaran = 2;
            $pendaftaran->save();
